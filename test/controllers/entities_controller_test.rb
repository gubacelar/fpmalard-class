...
class EntitiesControllerTest < ActionController::TestCase
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post :create, entity: { employee: @entity.employee, handle: @entity.handle, status: @entity.status }
    end
  ...
  test "should update entity" do
    patch :update, id: @entity, entity: { employee: @entity.employee, handle: @entity.handle, status: @entity.status }
    assert_redirected_to entity_path(assigns(:entity))
  end
